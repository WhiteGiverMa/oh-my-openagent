...
const nodes: BuildNode[] = [
	...
	// Bundle zod so native Windows Desktop can load the local dist without WSL .bun symlinks.
	{ id: "index", command: "bun", args: ["build", "packages/omo-opencode/src/index.ts", "--outdir", "dist", "--target", "bun", "--format", "esm"], deps: [] },
